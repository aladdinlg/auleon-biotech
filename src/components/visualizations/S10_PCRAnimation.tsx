...
const PHASE_LABELS: Record<Phase, { zh: string; en: string; desc: string }> = {
  denaturation: { zh: '变性', en: 'Denaturation', desc: '95°C：双链DNA解链为单链' },
  annealing:    { zh: '退火', en: 'Annealing',    desc: '60°C：引物与模板特异性结合' },
  extension:    { zh: '延伸', en: 'Extension',    desc: '72°C：Taq聚合酶合成新链' },
...
function amplificationRn(cycle: number, efficiency: number, _threshold: number): number {
...
export function S10_PCRAmplification() {
  ...
  return (
    <div className="space-y-5 p-4">
      <div className="text-center">
        <h3 className="text-base font-semibold text-gray-900 dark:text-slate-100">PCR扩增模拟器</h3>
        <p className="mt-0.5 text-xs text-gray-400">PCR Amplification Simulator · 实时热循环与qPCR扩增曲线</p>
      </div>
